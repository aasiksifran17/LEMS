...
$t = $result->FacultyCode;

$sql1 = "SELECT * from tblfaculty WHERE FacultyCode='{$t}'";
...
{
    $sql1 = "SELECT * from tblfaculty WHERE FacultyCode=:facultycode";
    $query1 = $dbh -> prepare($sql1);
    $query1->bindParam(':facultycode', $result->FacultyCode, PDO::PARAM_STR);
    $query1->execute();
...
{               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result1->FacultyName);?></td>
